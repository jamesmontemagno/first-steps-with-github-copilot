...
The shared model preference order is **GPT-6-Luna** (recommended), then **Auto** (balanced backup). The signup link is [github.com/features/copilot/plans](https://github.com/features/copilot/plans).
